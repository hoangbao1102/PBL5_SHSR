...
class WavRecorder(val context: Context) {
    ...
    fun startRecording(_filename: String? = null, internalStorage: Boolean = false, bufferElements2Rec: Int) {
        ...
        recordingThread = thread(true) {
            writeAudioDataToFile(path,bufferElements2Rec)
        }
    }
    ...
    private fun writeAudioDataToFile(path: String, BufferElements2Rec: Int) {
